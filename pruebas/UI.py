...
import requests
import json
import streamlit.components.v1 as components # <--- NUEVA LIBRERÍA AGREGADA
...
# PESTAÑA 2: ANÁLISIS (AQUI SE AGREGO EL WIDGET DE WATSON)
with tab2:
    ...
    # --- INICIO: CÓDIGO AGREGADO DE WATSON ORCHESTRATE ---
    st.subheader("💬 Watson Orchestrate Assistant")
    
    # Usamos components.html para inyectar el JS de Watson
    # Nota: Streamlit corre esto en un iframe, por lo que el chat aparecerá dentro de este bloque.
    components.html("""
        <script>
    ...
    """, height=600, scrolling=False) # Height 600 para dar espacio al chat desplegable
    # --- FIN: CÓDIGO AGREGADO DE WATSON ORCHESTRATE ---
